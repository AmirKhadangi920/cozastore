...
class CreateProduct extends FormRequest
{
    ...
    public function messages ()
    {
        return [
            ...
            'images.array' => 'دستکاری در اطلاعات ارسالی تشخیص داده شده است ، لطفا دوباره تلاش کنید .',
            'images.*.image' => 'فایل عکس محصولات را به درستی انتخاب کنید',
            'images.*.mimes' => 'فرمت عکس ها میبایست jpg , jpeg یا png باشد',
            'images.*.max' => 'حجم هر فایل عکس میبایست حداکثر 512 کیلوبایت باشد',

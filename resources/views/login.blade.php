		...
		<div class="wrapper  pa-0">
			<header class="sp-header">
				...
				<div class="form-group mb-0 pull-right">
					...
					<a class="inline-block btn btn-danger btn-rounded " href="signup.html">Sign Up</a>
				</div>
							...
							<div class="auth-form  ml-auto mr-auto no-float card-view pt-30 pb-30">
								<div class="row">
									<div class="col-sm-12 col-xs-12">
										<div class="mb-30">
											<h3 class="text-center txt-dark mb-10">Sign in to Splasher</h3>
										...
										<div class="form-wrap">
											<form action="#">
												...
												<div class="form-group">
													...
													<a class="capitalize-font txt-danger block mb-10 pull-right font-12" href="forgot-password.html">forgot password ?</a>
													<div class="clearfix"></div>
